...
<body>
    ...
    $patient_photo = $userfetch["pphoto"]; // Fetch the photo filename
                ...
                <td colspan="4">
                    ...
                    <center>
                        <table class="filter-container" style="border: none;" border="0">
                            ...
                            <tr>
                                <td style="width: 25%;">
                                    <a href="edit_profile.php" class="non-style-link">
                                        <div class="dashboard-items setting-tabs" style="padding:20px;margin:auto;width:95%;display: flex;">
                                            <div class="btn-icon-back dashboard-icons-setting" style="background-image: url('../img/icons/edit-iceblue.svg');"></div>

                                            <div>
                                                <div class="h1-dashboard" style="color: #007bff;">
                                                    Edit Profile
                                                </div><br>
